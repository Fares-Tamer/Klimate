...
export default function WeatherForecast({ data }: forecastProps) {
        ...
        <Card className='flex-1'>
            ...
            <CardContent>
                <div className='grid gap-4'>
                    {nextDays.map((day) => {
                        return (
                            <div key={day.date} className='grid grid-cols-2 sm:grid-cols-3 items-center gap-4 rounded-lg border p-4'>
                                <div>
